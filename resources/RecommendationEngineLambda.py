...
def calculate_match_scores(startup_preference_values, startup_preference_ranks, investors_attributes):
    ...
    for i, startup in enumerate(startup_preference_values):
        for investor in investors_attributes:
            ...
            match_scores_dict["primary_key"] = startup_name.replace(" ", "") + ':' + investor_name.replace(" ", "")
            match_scores_dict["match_score"] = compute_match_score(startup, investor, startup_ranks)
...
def lambda_handler(event, context):
    ...
    matches = calculate_match_scores(startup_preference_values, startup_preference_ranks, investors_attributes)
